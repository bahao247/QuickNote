...
{
    class QuickNoteCell: ViewCell
    {
        public QuickNoteCell()
        {
            ...
            {
                Children = { IDQuickNoteLabel, TypeQuickNoteLabel, DoneNoteSwitch },
            ...
            {
                Children = { NameQuickNoteLabel, DueDateNoteLabel},
                Orientation = StackOrientation.Horizontal
            };
